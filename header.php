...
<head>
	...
	<link rel="stylesheet" type="text/css" href="assets/common/css/styles.css?v=<?php echo time() ; ?>">
    <link rel="stylesheet" type="text/css" href="assets/common/css/pourosovaurl.css?v=<?php echo time() ; ?>">
...
<body>
	...
	<header>
		...
		<div class="container">
			<div class="DHeaderBanner" style="background-image:url(assets/media/common/header-bgR.jpg);background-repeat:no-repeat;width:100%;padding:10px 10px 10px 60px;margin-left:0px;">
				<div class="row">
					<div class="col-sm-12">
						<a href="index.php">
							...
							<div class="logo">
								<!-- <img class="img-responsive lgd-logo lgd-head-logo" src="assets/media/common/rounded.png"
									...
									width: 50%;"> -->
								<img class="img-responsive lgd-logo lgd-head-logo" src="assets/media/common/logo-en.png" align="left" alt="Tarabo Paurashava Logo" title="Tarabo Paurashava Logo" style="float: left;
									width: 50%;">
								<!-- <img class="img-responsive lgd-logo-bn lgd-head-logo"
									src="assets/media/common/rounded.png" align="left" alt="Tarabo Paurashava Logo"
									title="Tarabo Paurashava Logo" style="float: left;
									width: 50%;"> -->
								<img class="img-responsive lgd-logo-bn lgd-head-logo" src="assets/media/common/logo-bn.png" align="left" alt="Tarabo Paurashava Logo" title="Tarabo Paurashava Logo" style="float: left;
									width: 50%;">
							</div>
