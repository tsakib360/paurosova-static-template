						...
						<div class="col-sm-12 UPadding0">
							<div id="jssor_1"
								...
								<div data-u="slides"
									...
									<div><img data-u="image" src="assets/media/imgAll/gallery180220.jpg"></div>
								</div>
								<!-- Bullet Navigator -->
        ...
        <span class="UTitle UMarginTop20"><center><a href="http://digitalpaurashava.gov.bd">তারাব পৌরসভার সকল সেবা এখন অনলাইনে। নিবন্ধন করুন DigitalPaurashava.gov.bd তে। </a></center></span>
					...
					<div class="row UAboutTarabo">
						<div class="col-sm-12">
							...
							<h4 style="color:ffffff">তারাব পৌরসভা</h4>
							<p>তারাব পৌরসভা নারায়ণগঞ্জ জেলার রূপগঞ্জ থানায় অবস্থিত, বাংলাদেশের রাজধানী ঢাকার ১৪
								কিলোমিটার পূর্বে। “ঢাকা-সিলেট” মহাসড়ক, (সুলতানা কামাল সেতু সংলগ্ন), এই পৌরসভার ভিতর দিয়ে
								গিয়েছে। এটির আয়তন ২৪.৬০ বর্গ কিলোমিটার। এটির আছে ৯ টি ওয়ার্ড, ২০ টি মৌজা এবং ১,৫০,৭০৯
								জনসংখ্যা (উল্লেখঃ জনগণনা ২০১১) এবং দ্রুত বাড়ছে। এটি প্রথমে “সি” শ্রেণি পৌরসভা হিসেবে
								যাত্রা শুরু করলেও ৩'রা জুলাই, ২০১৩ তে “এ” শ্রেণিতে উন্নীত হয়।.</p>
						</div>
					</div>
				...
				<div class="col-sm-3 col-lg-pull-6 ULeftContain">
					...
					<a href="javascript:void(0)">
						...
						<div class="row UMarginTop15">
							<div class="col-sm-12">
								<h5 class="UTitle2">সংরক্ষিত আসনের কাউন্সিলরবৃন্দ</h5>
								<div class="UImageList">
					...
					<div>
						<h4 class="UTitle2">জরুরি হটলাইন<h4>
								<img alt="
  জরুরি হটলাইন 
  " src="assets/media/index_right/Hotline.jpg" style="width:100%;">
					</div>
				</div>
						...
						<div class="col-sm-12">
							...
							<div class="UCategoryList">
								<marquee direction="down" height="250" scrollamount="4" onMouseOver="this.stop()"
									...
									<div class="news-item">
										<a href="assets/media/Doc/notice2811.jpg" target="_blank">
									...
									<div class="news-item">
										<a href="assets/media/Doc/sanitation_notice.pdf" target="_blank">
											<p>তারাব পৌরসভার স্যানিটেশন সংক্রান্ত নোটিশ</p>
											<h5>২৩-১২-২০১৯</h5>
										</a>
									</div>
									<div class="news-item">
										<a href="assets/media/Doc/noc/NOC_of_Nazrul_Islam.pdf" target="_blank">
											<p>জনাব মোঃ নজরুল ইসলাম এর আন্তর্জাতিক পাসপোর্ট নবায়ন এর অনাপত্তি পত্র</p>
											<h5>১৬-০২-২০২০</h5>
										</a>
									</div>
									<div class="news-item">
										<a href="assets/media/Doc/Job_circular_1.pdf">
											<p>তারাব পৌরসভার নিয়োগ বিজ্ঞপ্তি</p>
											<h5>০২-০৭-২০২০</h5>
										</a>
									</div>
									<div class="news-item">
										<a href="assets/media/Doc/jobcircular2.pdf">
											<p>তারাব পৌরসভার পুনঃ নিয়োগ বিজ্ঞপ্তি</p>
											<h5>২৭-০৮-২০২০</h5>
										</a>
									</div>
									<div class="news-item">
										<a href="assets/media/Doc/forms/ApplicationForm.pdf">
											<p>তারাব পৌরসভার চাকুরী আবেদন ফরম</p>
											<h5>০২-০৭-২০২০</h5>
										</a>
									</div>
									<div class="news-item">
										<a href="assets/media/Doc/noc/Noc-Nazmul-Islam.pdf" target="_blank">
											<p>জনাব মোঃ নাজমুল ইসলাম এর আন্তর্জাতিক পাসপোর্ট নবায়ন এর NOC-02</p>
											<h5>২৯-০১-২০২১</h5>
										</a>
									</div>
									<div class="news-item">
										<a href="assets/media/Doc/noc/Noc-Nazmul-Islam-2.pdf" target="_blank">
